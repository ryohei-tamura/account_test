...
function addToCart(productId) {
    ...
    // ToDo products配列から該当する商品を探し変数productに代入 hint for文


    // ToDo カート内から該当する商品を探し、存在すれば、変数cartItemに代入 hint for文
...
function renderCart() {
    ...
    if (cart.length === 0) {
        ...
        for (let i = 0; i < cart.length; i++) {
            ...
            // ToDo 削除ボタンにクリックイベントのイベントリスナーを追加 hint イベントリスナー内で、適切な引数を添えてremoveFromCart関数を呼びだす
